...
infrastructure/
  database/
    ...
    migrations/     — SQLAlchemy migration scripts (replaces alembic/)
  external_api/
...
- **Cancellation**: Active tasks stored in `application.state.active_tasks` (in-memory dict), cancellable via `/stop`
